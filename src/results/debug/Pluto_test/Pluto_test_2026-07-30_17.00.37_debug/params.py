...
| `get_sdm()` | `sdm` | U(0.1, 2) | std of delta-magnitude distribution |
    """
    def __init__(self):
        self.fb  = 0.5038524300199865
        self.ka  = 3.277897252494091
        self.ae  = 1.6487802319326808
        self.ke  = 2.2877813775546607
        self.ai  = 1.9518507770128641
        self.ki  = 4.984945577365359
        self.mdm = 1.7448943048911911
        self.sdm = 1.1452369764023782

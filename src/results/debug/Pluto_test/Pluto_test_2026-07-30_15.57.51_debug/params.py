...
| `get_sdm()` | `sdm` | U(0.1, 2) | std of delta-magnitude distribution |
    """
    def __init__(self):
        self.fb  = 0.41951646611437876
        self.ka  = 2.1384845999669944
        self.ae  = 3.0672028663516904
        self.ke  = 2.6909319610120663
        self.ai  = 2.0141444479834374
        self.ki  = 5.0678937919019225
        self.mdm = 1.0605229712313924
        self.sdm = 0.6605660932940389

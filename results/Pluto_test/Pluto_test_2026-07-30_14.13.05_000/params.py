...
| `get_sdm()` | `sdm` | U(0.1, 2) | std of delta-magnitude distribution |
    """
    def __init__(self):
        self.fb  = 0.7628184327367276
        self.ka  = 5.3891999541989
        self.ae  = 2.2822566346302624
        self.ke  = 1.6083404456225041
        self.ai  = 1.9690551387609707
        self.ki  = 4.926685321494147
        self.mdm = 0.14640947270500643
        self.sdm = 0.28390239581999843

...
| `get_sdm()` | `sdm` | U(0.1, 2) | std of delta-magnitude distribution |
    """
    def __init__(self):
        self.fb  = 0.9868536421993718
        self.ka  = 9.361401775435333
        self.ae  = 6.415232798931843
        self.ke  = 4.933250237995006
        self.ai  = 1.4980418889461764
        self.ki  = 4.883076003417785
        self.mdm = 0.7773050301220008
        self.sdm = 1.0716449612674397

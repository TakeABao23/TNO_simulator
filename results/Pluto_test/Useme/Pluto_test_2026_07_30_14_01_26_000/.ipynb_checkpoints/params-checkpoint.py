...
| `get_sdm()` | `sdm` | U(0.1, 2) | std of delta-magnitude distribution |
    """
    def __init__(self):
        self.fb  = 0.9896565631500538
        self.ka  = 3.5062091993816296
        self.ae  = 3.327272551576964
        self.ke  = 5.597681097189719
        self.ai  = 2.041371095907852
        self.ki  = 4.983701501314141
        self.mdm = 0.21499750497619763
        self.sdm = 0.37610088010848686

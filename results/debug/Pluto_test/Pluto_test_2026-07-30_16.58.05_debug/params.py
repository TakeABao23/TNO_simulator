...
| `get_sdm()` | `sdm` | U(0.1, 2) | std of delta-magnitude distribution |
    """
    def __init__(self):
        self.fb  = 0.6628437941608438
        self.ka  = 3.6259907824427016
        self.ae  = 3.0144929221086136
        self.ke  = 2.157039743830707
        self.ai  = 1.9255375716720415
        self.ki  = 5.137253039990346
        self.mdm = -1.1445611438618033
        self.sdm = 2.8732759790335023

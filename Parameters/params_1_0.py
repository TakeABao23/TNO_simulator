...
| `get_sdm()` | `sdm` | U(0.1, 2) | std of delta-magnitude distribution |
    """
    def __init__(self):
        self.fb  = rng.uniform(0.0, 1.0)
        self.ka  = rng.uniform(0.1, 5.0)
        self.ae  = rng.uniform(0.5, 5.0)
        self.ke  = rng.uniform(0.5, 5.0)
        self.ai  = rng.uniform(1.9, 2.1)
        self.ki  = rng.uniform(4.9, 5.1)
        self.mdm = rng.uniform(0.0, 4.0)
        self.sdm = rng.uniform(0.1, 2.0)
